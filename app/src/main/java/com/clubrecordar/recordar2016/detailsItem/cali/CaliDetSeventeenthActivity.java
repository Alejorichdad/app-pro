...
/**
 * Created by alejorichdad on 1/21/17.
 */
public class CaliDetSeventeenthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cali_det_seventeenth);
