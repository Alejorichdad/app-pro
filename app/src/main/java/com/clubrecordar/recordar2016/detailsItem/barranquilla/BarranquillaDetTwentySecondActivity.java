...
/**
 * Created by alejorichdad on 1/31/17.
 */

public class BarranquillaDetTwentySecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barranquilla_det_twentysecond);
