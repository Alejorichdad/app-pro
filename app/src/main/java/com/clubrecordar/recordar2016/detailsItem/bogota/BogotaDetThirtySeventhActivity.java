...
/**
 * Created by alejorichdad on 8/25/16.
 */
public class BogotaDetThirtySeventhActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bogota_det_thirtyseventh);
